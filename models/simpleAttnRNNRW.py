...
class simpleAttnRNNRW(BasicModule):
    def __init__(self, args, embed=None):
        super(simpleAttnRNNRW,self).__init__(args)
        self.model_name = 'simpleAttnRNNRW'
        self.args = args
        ...
        for index in range(0,B):
            ...
            for position, h in enumerate(valid_hidden):
               ...
               # content = self.dropout(content)
                ...
                probs.append(prob)
        return torch.cat(probs).squeeze(), at_scores, word_scores
